...
console.log("build and deploy shplayer to " + runMode);
...
console.log("start build: ng build --configuration=" + stage + " --base-href=/" + base_href + "/ --output-path=dist");
execSync("ng build --configuration=" + stage + " --base-href=/" + base_href + "/ --output-path=dist");
